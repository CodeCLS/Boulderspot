                ...
                .addOnSuccessListener(activity, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            Log.d(TAG,"seq36s" + pendingDynamicLinkData.getLink());
                            if (pendingDynamicLinkData.getLink().getQueryParameter("PostID") != null
                            && pendingDynamicLinkData.getLink().getQueryParameter("UserID") != null
                            && pendingDynamicLinkData.getLink().getQueryParameter("Type") != null
                            && pendingDynamicLinkData.getLink().getQueryParameter("Source") != null){
                                Log.d(TAG,"seq37s");
                                ...
                                if (postid!= null && Source != null && userID != null && type != null){
