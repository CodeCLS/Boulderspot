...
public class Adapter_Statistics_Boulder_Item extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Adapter_Statistics_Boulder_Item(ArrayList training_boulder_tries, ArrayList training_boulder_time, ArrayList training_boulder_grade, ArrayList training_boulder_notes) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType==0) {
            view = LayoutInflater.from(mContext).inflate(R.layout.private_statistics_boulder_ui,parent,false);
