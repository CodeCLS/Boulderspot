...
public class friend_location_list_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public friend_location_list_adapter(ArrayList<String> friend_id, ArrayList<String> friend_location_status, ArrayList<String> friend_location_time, ArrayList<String> friend_name, ArrayList<String> friend_url_img) {
