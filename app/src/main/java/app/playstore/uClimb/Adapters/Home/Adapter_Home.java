...
//
   ...
   // }
    ...
    private void user_transaction(int position) {
        custom_profile custom_profile = new custom_profile();
        Bundle bundle = new Bundle();
        bundle.putString("uid",array_uid.get(position));
    ...
    private void share_onClick(ImageView share_btn,int i) {
      share_btn.setOnClickListener(v -> {
          presenter_home_posts.share_link(mContext,array_post_id.get(i),array_source.get(i),array_type.get(i),array_uid.get(i));
