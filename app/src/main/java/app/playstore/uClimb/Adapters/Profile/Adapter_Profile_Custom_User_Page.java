...
public class Adapter_Profile_Custom_User_Page extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == 2){
            ...
            //Toast.makeText(mContext,R.string.mehr_lange_druecken, Toast.LENGTH_SHORT).show();
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getItemViewType() == 0){
            ...
            setSocialData(standart_profile_view.spinner_follower,standart_profile_view.spinner_following,standart_profile_view.txt_follower,standart_profile_view.txt_following);
        ...
        if (holder.getItemViewType() == 2){
            ...
            custom_profile.getSource(mContext,position,uploads_viewholder_profile_custom.img,uploads_viewholder_profile_custom.exoPlayer,uploads_viewholder_profile_custom.progress_custom_upload_profile,custom_profile,holdertype,posts,uploads_viewholder_profile_custom.button,uid);
    ...
    private void setSocialData(Spinner Follower, Spinner Following,TextView txt_Follower,TextView txt_Following) {
        Presenter_Custom_Profile custom_profile = new Presenter_Custom_Profile();
        custom_profile.getUserData(mContext,Follower,Following,uid,txt_Follower,txt_Following);
    ...
    public void addPosts(Context back_context,int position, ImageView img, SimpleExoPlayerView exoPlayer,ProgressBar progressBar, int holdertype, ArrayList<String> source, ArrayList type,Button more,ArrayList posts,String uid) {
            ...
            if (type.get(position).equals("Video")){
                ...
                more.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        transactionPost(source, position, type,posts,back_context,uid);
    ...
    private void transactionPost(ArrayList<String> source, int position, ArrayList type, ArrayList post, Context mContext, String uid) {
        Log.d(TAG,"Posts232" + posts);
        custom_post_page custom_post_page = new custom_post_page();
        Bundle bundle = new Bundle();
        bundle.putString("Source",source.get(position));
        bundle.putString("Type",type.get(position).toString());
        bundle.putString("UserID",uid);
        bundle.putString("PostID",post.get(position).toString());
        custom_post_page.setArguments(bundle);
        FragmentManager fragmentManager = ((AppCompatActivity)mContext).getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction().replace(R.id.container_fragment,custom_post_page).addToBackStack("Custom_User").setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
    ...
    public class uploads_viewholder_profile_custom extends RecyclerView.ViewHolder {
        ...
        public uploads_viewholder_profile_custom(View view) {
            super(view);
            button = view.findViewById(R.id.btn_more);
