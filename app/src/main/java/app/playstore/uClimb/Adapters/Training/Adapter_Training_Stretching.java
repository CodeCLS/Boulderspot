...
public class Adapter_Training_Stretching extends RecyclerView.Adapter<Adapter_Training_Stretching.ViewHolder1> {
    private ArrayList<String> source = new ArrayList<>();
    private ArrayList<String> text = new ArrayList<>();
    private int video_state = 0;
    private Context mContext;

    public Adapter_Training_Stretching(ArrayList<String> source, ArrayList<String> text) {
        this.source = source;
        this.text = text;
    }
    ...
    public ViewHolder1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.main_custom_stretch_ui,parent,false);
