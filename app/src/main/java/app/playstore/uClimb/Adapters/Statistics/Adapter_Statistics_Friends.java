...
public class Adapter_Statistics_Friends extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList competition_name;
    private ArrayList competition_Accomplishment;
    private Context mContext;

    public Adapter_Statistics_Friends(ArrayList competition_name, ArrayList competition_Accomplishment) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = null;
        if (viewType==0) {
            view = LayoutInflater.from(mContext).inflate(R.layout.private_statistics_skala_friends_item, parent);
        }
