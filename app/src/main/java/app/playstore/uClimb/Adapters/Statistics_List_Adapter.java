...
public class Statistics_List_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Statistics_List_Adapter(ArrayList training_boulder_time, ArrayList training_boulder_grade, ArrayList training_boulder_notes,String intent_type) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getItemViewType() == 3){
            ...
            Log.d(TAG,"training_sessions" + training_session_time + " others: " + sesssions_train_time);
            if (position> training_session_time.size()){
                return;
            }
