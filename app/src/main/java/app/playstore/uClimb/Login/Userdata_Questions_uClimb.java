...
public class Userdata_Questions_uClimb extends Base_Internet {
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getCities().contains(edit_country.getText().toString())&& getGrade().contains(edit_grade.getText().toString())) {
                    if (check_fields()) {
                        Snackbar snackbar = Snackbar.make(Userdata_Questions_uClimb.this.getWindow().getDecorView(), "Please fill all the fields", BaseTransientBottomBar.LENGTH_SHORT);
                    ...
                    Snackbar snackbar = Snackbar.make(Userdata_Questions_uClimb.this.getWindow().getDecorView(),"Please enter a correct country or grade", BaseTransientBottomBar.LENGTH_SHORT);
                    snackbar.show();
                }
            }
        });
    ...
    private void succesfully_registered() {
        Snackbar snackbar = Snackbar.make(Userdata_Questions_uClimb.this.getWindow().getDecorView(),"Succesfully registered", BaseTransientBottomBar.LENGTH_SHORT);
        snackbar.show();
        snackbar.setBackgroundTint(getResources().getColor(R.color.colorPrimaryDark));
        ...
        Presenter_Register register_presenter = new Presenter_Register();
        Log.d(TAG,"username1"+username);

        register_presenter.RegisterNewUser(pwd, email, username, Userdata_Questions_uClimb.this,bundle, Userdata_Questions_uClimb.this.getWindow().getCurrentFocus());
    ...
    private void Toast_fill() {
        Toast.makeText(Userdata_Questions_uClimb.this, "Fill in all fields", Toast.LENGTH_SHORT).show();
    }



    private void MainIntent() {
        //Log.d(TAG,"MAININTENT");
        //Intent intent = new Intent(Userdata_Questions_uClimb.this, MainActivity.class);
