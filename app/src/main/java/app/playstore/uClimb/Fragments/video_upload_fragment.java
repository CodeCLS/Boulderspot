                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                Log.d(TAG,"selected_video: " + selected_video + " selectedImg: " + selected_img + " uri: " + selectedUri);
                                if (selected_video){
                                        ...
                                        Presenter_Login login_presenter = new Presenter_Login();
                                        String uid = login_presenter.getUID(getContext());
                                        storageRefPath = storageRef.child("Sources_Users_Uploads").child(uid).child(randomhashpath + "__thumb");



                                                        Log.d(TAG,"Success23") ;
                                                        Presenter_Video video_presenter = new Presenter_Video(place_id,spinner_grade.getSelectedItem().toString(),spinner_impression_grade.getSelectedItem().toString(),spinner_route_type.getSelectedItem().toString(),spinner_tries.getSelectedItem().toString(),place_Name,s,uri);
            ...
            public void run() {
                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Uri uri1 = null;
                        Presenter_Video video_presenter = new Presenter_Video(place_id,spinner_grade.getSelectedItem().toString(),spinner_impression_grade.getSelectedItem().toString(),spinner_route_type.getSelectedItem().toString(),spinner_tries.getSelectedItem().toString(),place_Name,s, uri1);
                        video_presenter.addSuccess(getContext(),random(10),source_status,statistics_status,uri);
