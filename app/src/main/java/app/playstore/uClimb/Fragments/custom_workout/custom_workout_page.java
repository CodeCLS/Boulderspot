...
public class custom_workout_page extends Fragment {
    ...
    private void initViews(View view) {
        ...
        tabs.add(new Flaretab(getResources().getDrawable(R.mipmap.training_icon),"Training","#FFECB3"));
        tabs.add(new Flaretab(getResources().getDrawable(R.mipmap.training_icon),"Dehnen","#80DEEA"));
        tabs.add(new Flaretab(getResources().getDrawable(R.mipmap.training_icon),"Aufwärmen","#B39DDB"));
