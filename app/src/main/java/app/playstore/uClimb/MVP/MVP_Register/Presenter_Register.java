...
import app.playstore.uClimb.Login.Userdata_Questions_uClimb;
...
public class Presenter_Register {
    ...
    private String pwd;
    private Model_Register register_model;
    private FirebaseAuth mAuth;

    public Presenter_Register() {
        register_model = new Model_Register();
