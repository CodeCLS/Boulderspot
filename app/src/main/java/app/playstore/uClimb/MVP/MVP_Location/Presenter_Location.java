        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot : dataSnapshot.child("User").child(uid).child("Friends").getChildren()) {
                    ...
                    && dataSnapshot.child("User").child(postSnapshot.getKey()).child("IMG").exists() &&dataSnapshot.child("User").child(postSnapshot.getKey()).child("Position").child("position_status").exists()) {
