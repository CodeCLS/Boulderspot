...
public class Presenter_Login {
    ...
    public void login(Context mContext , String email, String pwd_hash) {
        ...
        Log.d(TAG,"hellloo21" + pwd_hash + " " + email);
                            ...
                            if (task.isSuccessful()) {
                                ...
                                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        //if (dataSnapshot.child(user.getUid()).child("StatisticsID").exists()) {
...
//
    ...
    public String getStatisticsID(Context mContext) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                //if (dataSnapshot.child("User").child(getUID(mContext)).child("StatisticsID").exists()) {
    ...
    public void getFriendsCompeting(Context mContext, View view) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child("User").child(getUID(mContext)).child("Friends").exists()) {
