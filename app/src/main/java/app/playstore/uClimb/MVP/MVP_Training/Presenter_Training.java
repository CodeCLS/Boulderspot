            ...
            public void onClick(View v) {
                ...
                if (btn_add_status ==0){
                    if (info.getText().toString().length() >1 && info.getText().toString().length() < 60){
                        if (edit_add_workout_log.getText().toString().trim().length() >1 && edit_add_workout_log.getText().toString().trim().length() < 15){
                            ...
                            databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (dataSnapshot.child("User").child(uid).child("Points").exists()) {
                                        ...
                                        databaseReference1.child("User").child(uid).child("Points").setValue(points + (Integer.parseInt(Hang_Time) * 0.05 - Integer.parseInt(Pause_Time) * 0.05) + Integer.parseInt(Sets) + Integer.parseInt(Rounds));
